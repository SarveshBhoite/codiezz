  ...
  return (
    ...
    >
      ...
      <div className="container relative section-title-container">
        ...
        <div className="circle -left-4 -bottom-5"></div>
        <div className="circle -top-5 -left-4"></div>
        <div className="circle -right-1 -bottom-5 lg:-right-4"></div>
        <div className="circle -top-5 -right-4"></div>
      </div>
      ...
      <div className="border-t w-full border-b md:border-b-0 border-light-gray">
        <div className="container relative">
          <div className="overflow-hidden lg:border-x border-light-gray relative px-0">
            {/* ▣ NEW DESKTOP SLIDER (INFINITE LOOP) */}
          ...
          <div className="circle -left-4 -bottom-4 hidden md:block"></div>
          <div className="circle -right-5 -bottom-5 hidden md:block"></div>
        </div>
      </div>
